...
import static edu.aku.hassannaqvi.covidimmunity.core.MainApp.sdDir;
import static edu.aku.hassannaqvi.covidimmunity.core.MainApp.uploadData;
...
import edu.aku.hassannaqvi.covidimmunity.models.SyncModel;
import edu.aku.hassannaqvi.covidimmunity.workers.DataDownWorkerALL;
import edu.aku.hassannaqvi.covidimmunity.workers.DataUpWorkerALL;
        ...
        if (sdDir.exists()) {
            ...
            if (files.length > 0) {
                ...
                for (int i = 0; i < fcount; i++) {
                    TextView textView = new TextView(edu.aku.hassannaqvi.covidimmunity.ui.SyncActivity.this);
                        ...
                        public void run() {
                          ...
                          //  OneTimeWorkRequest photoUpload = new OneTimeWorkRequest.Builder(PhotoUploadWorker2.class).setInputData(data).setConstraints(constraints).build();
                            ...
                            WorkManager.getInstance(SyncActivity.this).getWorkInfoByIdLiveData(photoUpload.getId())
                                    .observe(edu.aku.hassannaqvi.covidimmunity.ui.SyncActivity.this, new Observer<WorkInfo>() {
                                        ...
                                        public void onChanged(@Nullable WorkInfo workInfo) {
                                            ...
                                            if (workInfo.getState() == WorkInfo.State.FAILED) {
                                                Toast.makeText(edu.aku.hassannaqvi.covidimmunity.ui.SyncActivity.this, "Failed", Toast.LENGTH_SHORT).show();
