...
import static edu.aku.hassannaqvi.covidimmunity.core.MainApp.TAJIKISTAN;
import static edu.aku.hassannaqvi.covidimmunity.core.MainApp.sharedPref;
import static edu.aku.hassannaqvi.covidimmunity.database.CreateTable.DATABASE_COPY;
...
*//*
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.covidimmunity.ui.SyncActivity.class).putExtra("login", true));
        } else {
